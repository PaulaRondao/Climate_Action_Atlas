...
export enum Description {
  ...
  AccountDelete = "La suppression de votre compte entraîne la désactivation immédiate de votre accès à votre espace personnel, la suppression des initiatives que vous avez créé ainsi que la suppression définitive de l'ensemble de vos données personnelles. Cette suppression est irréversible et sera effectuée dans un délai maximum d'un mois suivant votre demande. Si vous souhaitez que vos initiatives restent visibles sur la carte après la suppression de votre compte, vous avez la possibilité de demander leur anonymisation. Dans ce cas, toute référence à votre identité sera supprimée et les initiatives ne seront plus associées à votre compte. Pour en faire la demande, il vous suffit de contacter notre équipe par e-mail avant de procéder à la suppression de votre compte.",
}
