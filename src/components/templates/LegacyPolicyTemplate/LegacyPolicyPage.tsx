  ...
  <Container>
    ...
    <ul>
      <li>
        ...
        il peut s’agir : de ses noms et prénoms, de son âge, de son adresse postale ou email, de sa
        localisation ou encore de son adresse IP ;
      </li>
    ...
    <p>
      ...
      consultables par les utilisateurs à l’adresse suivante :
    ...
    <ul>
      ...
      <li>
        ...
        ou les dégâts d&apos;origine accidentelle, à l&apos;aide de mesures techniques ou
    ...
    <ul>
      ...
      <li>
        ...
        concernée est partie ou à l&apos;exécution de mesures précontractuelles prises à la demande
        de celle-ci ;{' '}
      </li>
      <li>
    ...
    <p>Pour la gestion de l&apos;espace client</p>
    ...
    <p>
      [Liste des données automatiquement collectées lors de la simple visite de l’utilisateur sur le
      site]
    </p>
    <p>
    ...
    <p>[Lister les données personnelles collectées, et préciser la finalité de la collecte]</p>
    <p>
      Elles sont conservées par le responsable du traitement dans des conditions raisonnables de
      sécurité, pour une durée de : [Indiquer la durée de conservation prévue] La société est
      susceptible de conserver certaines données à caractère personnel au-delà des délais annoncés
      ci-dessus afin de remplir ses obligations légales ou réglementaires.{' '}
    </p>
    <h3>Article 3.3 : Hébergement des données </h3>
    <p>Le site Climate Action Atlas est hébergé par : </p>
    <p>la société Vercel, situé Vercel Inc. </p>
    <p>
      Adresse du siège social : 440 N. Barranca Ave #4133 Covina California 9172, (contact
      téléphonique ou email : +18662583217).
    </p>
    <p>
      Contact maud.rondao@gmail.com [Dans le cas ou les données personnelles collectées par
      l’entreprise seraient partagées avec des tiers, insérer une clause “Article 3.4 : Transmission
      des données à des tiers” : “Les données peuvent être transmises à nos partenaires, ci-après
      énumérés :”] [Si le site est concerné par l’utilisation de cookies, préciser leur utilisation
      dans un Article 3.5 : Politique en matière de “cookies”]{' '}
    </p>
    <h2>
    ...
    <p>
      ...
      d’immatriculation est le [indiquez votre numéro RCS]. Le responsable du traitement des données
      à caractère personnel peut être contacté de la manière suivante : Par courrier à l’adresse :
      [indiquez l’adresse du siège social] ; Par téléphone, au [numéro de téléphone] ; Par mail :
      [email du responsable du traitement des données].{' '}
    </p>
    <h3>Article 4.2 : Le délégué à la protection des données</h3>
    <p>
      Le délégué à la protection des données de l’entreprise ou du responsable est : [Indiquez
      l’identité, l’adresse, le numéro de téléphone et/ou l’adresse email du DPO] Si vous estimez,
    ...
    <p>
      en application du règlement européen 2016/679 et de la Loi Informatique et Liberté (Loi 78-17
      du 6 janvier 1978) :{' '}
    </p>
    <p>
    ...
    <ul>
      <li>
        Droit d’accès, de rectification et droit à l’effacement des données (articles 15, 16 et 17
        du RGPD)
      </li>
    ...
    <p>
      Pour exercer vos droits, veuillez adresser votre courrier à [Nom et adresse de l’entreprise]
      ou par mail à maud.rondao@gmail.com
    </p>
    <p>
    ...
    <p>
      L’éditeur du site Climate Action Atlas se réserve le droit de pouvoir modifier la présente
      ...
      éditée le 05/01/2026, a été mise à jour le 05/01/2026.
    </p>
  </Container>
);
