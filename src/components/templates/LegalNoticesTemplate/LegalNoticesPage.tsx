...
const LegalNoticesPage = (): JSX.Element => (
  <Container>
    ...
    <p>
      ...
      l&apos;économie numérique, il est précisé aux utilisateurs du site Climate Action Atlas
      l&apos;identité des différents intervenants dans le cadre de sa réalisation et de son suivi.
    </p>

    <h2>Édition du site</h2>
    <p>
      Le présent site, accessible à l’URL www.climate-action-atlas.fr (le « Site »), est édité par :
      Maud Paula Rondao, résidant 47 chemin des alouettes 17610 Chaniers, de nationalité Française
      (France), né(e) le 19/07/1987,
    </p>
    <h2>Hébergement</h2>
    <p>
      Le Site est hébergé par la société Vercel, situé Vercel Inc. Adresse postale : 440 N. Barranca
      Ave #4133 Covina California 9172, (contact téléphonique ou email : +18662583217).
    </p>
    ...
    <p>
      ...
      vie privée, disponible depuis la section &quot;Charte de Protection des Données
